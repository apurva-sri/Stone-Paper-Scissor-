...
const genCompChoice = () =>{
    ...
    const randIdx = Math.floor(Math.random()*3);//Math.random funstion generate random numbers between 0-1 and Math.random()*3 generate no. btw 0-2, Math.random()*5 generate no. btw 0-4 etc..
...
const playGame = (userChoice) =>{
    ...
    //generate computer choice & genetrating functions for perticular work is called modular
